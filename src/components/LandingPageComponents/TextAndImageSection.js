      ...
      >
        ...
        >
          <div className="w-full xl:w-min xl:min-w-[500px] 2xl:min-w-[600px] flex justify-center items-start max-[850px]:justify-center max-[850px]:items-center  flex-col max-[850px]:text-center text-left">
            ...
            {/* Title */}
            <div className="flex flex-col items-start justify-start mt-10 md:mt-6 mb-10 md:mb-12">
              {words.map((word, i) => (
                <motion.h2
                  key={i}
                  ...
                  className="display-font text-center md:text-left text-foreground-dark text-[44px] md:text-[55px] lg:text-[86px] 2xl:text-[100px] min-[2048px]:text-[150px] font-bold leading-[1] "
                >
                  {word.trim()}
                </motion.h2>
              ))}
