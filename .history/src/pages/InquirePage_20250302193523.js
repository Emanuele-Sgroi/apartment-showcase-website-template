      ...
      {inquirePageContent && globalsContent && (
        <>
          ...
          <div className="w-full max-w-[1260px] min-[2048px]:max-w-[1450px] py-[30px] md:py-[60px] 2xl:py-[90px] min-[2048px]:py-[120px] px-8">
            <div className="w-full flex flex-col md:flex-row items-start md:items-end justify-start gap-6 md:gap-20 border-b border-background-dark pb-8 ">
              <h2 className="display-font text-[60px] xl:text-[78px] min-[2048px]:text-[100px] leading-[1]">
                {inquirePageContent.inquireSectionTitle}
              </h2>
              <p className="text-left text-md xl:text-lg min-[2048px]:text-[24px]">
                {inquirePageContent.inquireSectionDescription}
              </p>
            </div>
            <div className="w-full flex justify-between gap-16 xl:gap-24 pt-12">
              <InquireForm />
