...
const InquirePage = () => {
  ...
  return (
    <main className="w-full flex flex-col items-center justify-center relative overflow-hidden min-h-screen">
      {isLoading && <Loading />}
      ...
      {inquirePageContent && globalsContent && (
        <>
          ...
          />
          <div className="w-full max-w-[1862px] py-[56px] md:py-[80px] 2xl:py-[120px] min-[2048px]:py-[280px] px-8">
