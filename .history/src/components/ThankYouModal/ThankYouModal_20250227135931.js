...
const ThankYouModal = ({ isOpen, onClose }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-[1000px] flex  bg-background-light overflow-hidden !border-none !p-0 !m-4 z-[99999]">
        {/* Left Section (Text) */}
        <div className="w-1/2 p-10 flex flex-col justify-center items-start">
          <DialogTitle className="display-font text-foreground-dark text-2xl md:text-3xl font-bold mb-4">
