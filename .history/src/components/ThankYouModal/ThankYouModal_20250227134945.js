...
const ThankYouModal = ({ isOpen, onClose }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        hideClose
        className="max-w-3xl w-full flex flex-col md:flex-row rounded-lg shadow-xl bg-background-light overflow-hidden z-[99999]"
      >
        <DialogClose className="!text-red-300"></DialogClose>
        {/* Left Section (Text) */}
