...
const ThankYouModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-[1000px] min-[2048px]:max-w-[1200px] min-h-[500px] flex  bg-background-light overflow-hidden !border-none !p-0 !m-4 z-[99999]">
        {/* Left Section (Text) */}
        <div className="w-1/2 p-10 flex justify-center items-center overflow-y-auto">
          <div className="flex flex-col justify-center items-start">
            ...
            <DialogDescription className="text-foreground-dark text-md leading-relaxed mb-6 min-[2048px]:mb-12">
