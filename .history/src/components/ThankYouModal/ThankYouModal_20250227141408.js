...
const ThankYouModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full maxxl:max-w-[1000px] min-[2048px]:max-w-[1200px] min-h-[500px] flex  bg-background-light overflow-hidden !border-none !p-0 z-[99999]">
        {/* Left Section (Text) */}
