...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-background-dark">
      <div className="w-full py-[56px] md:py-[80px] 2xl:py-[120px]  px-8 md:px-12 xl:px-24 min-[2048px]:px-[170px] text-foreground-light">
          ...
          <div className="flex-1 flex flex-col items-start justify-start gap-24 ">
            ...
            <div className="w-full">
              <p className="text-base text-foreground-light">
                ...
                the condominium or any other exclusive listings by other brokers
                at the property. While every effort is made to ensure the
                accuracy of the information on this website, it is subject to
                change without notice, and no warranty, express or implied, is
                made as to its completeness or accuracy. Verify all information
                independently. Images on this website are used for illustrative
                purposes only and are obtained from publicly available real
                estate listings. All images are the copyright of their
                respective owners. Gene Maltsev makes no claim of ownership to
                these images and uses them solely to provide visual context for
                the building information. Any use of these images without the
                express permission of the copyright holder is strictly
                prohibited. If you are a copyright holder and object to the use
                of an image, please contact us for removal. For more information
                on Gene Maltsev, visit genesteam.com.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-background-light text-center py-1 px-2">
        <p className="text-foreground-dark text-xs mt-1">
