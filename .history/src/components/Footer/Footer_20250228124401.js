...
const Footer = () => {
  ...
  if (!globalsContent || isGlobalsLoading) {
    return (
                ...
                <div className="flex-1 flex flex-col items-start justify-start gap-12 xl:gap-24 ">
                  ...
                  <div className="w-full">
                    <p className="text-base min-[2048px]:text-lg text-foreground-light">
                      ...
                      operated by Gene Maltsev, a Licensed Real Estate Agent in
                      New York City. This website is for informational purposes
                      only and does not constitute an offer to sell or a
                      solicitation of an offer to buy any property. This website
                      is not affiliated with the condominium or any other
                      exclusive listings by other brokers at the property. While
                      every effort is made to ensure the accuracy of the
                      information on this website, it is subject to change
                      without notice, and no warranty, express or implied, is
                      made as to its completeness or accuracy. Verify all
                      information independently. Images on this website are used
                      for illustrative purposes only and are obtained from
                      publicly available real estate listings. All images are
                      the copyright of their respective owners. Gene Maltsev
                      makes no claim of ownership to these images and uses them
                      solely to provide visual context for the building
                      information. Any use of these images without the express
                      permission of the copyright holder is strictly prohibited.
                      If you are a copyright holder and object to the use of an
                      image, please contact us for removal. For more information
