...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-background-dark py-[56px] md:py-[80px] 2xl:py-[120px]  px-8 md:px-12 xl:px-24 min-[2048px]:px-[170px]">
        ...
        <div className="flex flex-col items-start justify-start gap-4">
          ...
          <div className="flex flex-col items-start justify-start">
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="underline text-base uppercase text-foreground-light"
            >
              FAIR HOUSING
            </Link>
          </div>
