...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-red-500 py-[56px] md:py-[80px] 2xl:py-[120px]  px-8 md:px-12 xl:px-24 min-[2048px]:px-[170px] text-foreground-light">
      <div className="w-full flex items-start justify-center gap-36">
        {/* Left part */}
        ...
        <div className="flex-1 flex flex-col items-start justify-start gap-24 ">
          {/* Contacts */}
          <div className="w-[60%] flex items-center justify-between gap-6">
            {/* Email */}
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-start justify-center gap-0">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="underline text-base font-semibold tracking-wider uppercase text-left"
                >
                  example@gmail.com
                </Link>
              </div>
          ...
          <div className="w-full">
            <p className="text-base text-foreground-light">
              ...
              operated by Gene Maltsev, a Licensed Real Estate Agent in New York
              City. This website is for informational purposes only and does not
              constitute an offer to sell or a solicitation of an offer to buy
              any property. This website is not affiliated with the condominium
              or any other exclusive listings by other brokers at the property.
              While every effort is made to ensure the accuracy of the
              information on this website, it is subject to change without
              notice, and no warranty, express or implied, is made as to its
              completeness or accuracy. Verify all information independently.
              Images on this website are used for illustrative purposes only and
              are obtained from publicly available real estate listings. All
              images are the copyright of their respective owners. Gene Maltsev
              makes no claim of ownership to these images and uses them solely
              to provide visual context for the building information. Any use of
              these images without the express permission of the copyright
              holder is strictly prohibited. If you are a copyright holder and
              object to the use of an image, please contact us for removal. For
              more information on Gene Maltsev, visit genesteam.com.
            </p>
          </div>
        </div>
      </div>
