...
/**
 * InquireForm - a dynamic form with conditional fields based on user selections.
 */
const InquireForm = () => {
  // ----------------
  // State Management
  ...
  const [formData, setFormData] = useState({
    ...
    // Questions (default selections)
    isAgentOrBroker: "No", // Q1 default: "No"
    brokerageName: "", // appears if Q1 = "Yes"

    isRepresented: "No", // Q2 default: "No"
    representativeBrokerageFirm: "", // if Q2 = "Yes"
    interestedInAgent: "", // if Q2 = "No"

    interestedIn: "Renting", // Q3 default: "Renting"
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.interestedIn === "Buying") {
      ...
      // preApproved is a text field; not strictly required by your specs
    }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="w-full flex flex-wrap gap-12 mb-12">
        {/* Q1 and Q2 */}
        <div className="w-full flex justify-between gap-12">
          {/* Q1: Are you an agent or a broker? (radio) */}
            ...
            <div className="flex items-center gap-4">
              <label className="flex items-center gap-1">
                <input
                  ...
                  value="Yes"
                  checked={formData.isAgentOrBroker === "Yes"}
                  onChange={handleChange}
                />
                Yes
              </label>
              <label className="flex items-center gap-1">
                <input
                  ...
                  name="isAgentOrBroker"
                  value="No"
                  checked={formData.isAgentOrBroker === "No"}
                  onChange={handleChange}
                />
                No
              </label>
          ...
          {/* Q2: Are you represented by an agent or broker? (radio) */}
          <div className="flex flex-col w-full max-w-[400px]">
            <label className="text-md text-foreground-dark uppercase mb-2">
            ...
            <div className="flex items-center gap-4">
              <label className="flex items-center gap-1">
                <input
                  ...
                  name="isRepresented"
                  value="Yes"
                  checked={formData.isRepresented === "Yes"}
                  onChange={handleChange}
                />
                Yes
              </label>
              <label className="flex items-center gap-1">
                <input
                  ...
                  name="isRepresented"
                  value="No"
                  checked={formData.isRepresented === "No"}
                  onChange={handleChange}
                />
                No
              </label>
        ...
        <div className="flex items-center gap-4 mt-2">
          <label className="flex items-center gap-1">
            <input
              ...
              name="interestedIn"
              value="Renting"
              checked={formData.interestedIn === "Renting"}
              onChange={handleChange}
            />
            Renting
          </label>
          <label className="flex items-center gap-1">
            <input
              ...
              name="interestedIn"
              value="Buying"
              checked={formData.interestedIn === "Buying"}
              onChange={handleChange}
            />
            Buying
          </label>
          <label className="flex items-center gap-1">
            <input
              ...
              name="interestedIn"
              value="Selling"
              checked={formData.interestedIn === "Selling"}
              onChange={handleChange}
            />
            Selling
          </label>
