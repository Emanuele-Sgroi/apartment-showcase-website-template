        ...
        <>
          ...
          <div className="w-full mb-12">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-transparent border-b border-background-dark outline-none focus:ring-0 text-foreground-dark w-full"
            />
          </div>
        </>
      )}
      ...
      {formData.interestedIn === "Selling" && (
        <>
          ...
          <div className="flex justify-between gap-12 w-full mb-12">
            {/* Street */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase mb-1">Street *</label>
              <input
                type="text"
            ...
            {/* City */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase mb-1">City *</label>
              <input
                type="text"
          ...
          <div className="flex justify-between gap-12 w-full mb-12">
            {/* State */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase mb-1">State *</label>
              <input
                type="text"
            ...
            {/* Zip Code */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase mb-1">Zip Code *</label>
              <input
                type="text"
          ...
          {/* Layout (Full Width) */}
          <div className="w-full mb-12">
            <label className="block text-md uppercase mb-1">Layout *</label>
            <Select
