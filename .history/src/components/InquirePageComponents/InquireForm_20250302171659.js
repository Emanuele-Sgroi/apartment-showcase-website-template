      ...
      {formData.interestedIn === "Selling" && (
        <>
          ...
          <div className="flex items-center gap-2">
            <div className="w-4 h-px bg-foreground-dark opacity-50" />
            <p className="uppercase text-sm font-semibold text-foreground-dark">
              Proprerty address:
            </p>
          </div>
          ...
          {/* Desired Timeline & Price side by side */}
          <div className="flex justify-between gap-12 w-full mb-12">
            {/* Desired Timeline */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase mb-1">
