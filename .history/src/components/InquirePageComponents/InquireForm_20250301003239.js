      ...
      {formData.interestedIn === "Renting" && (
        <>
          ...
          <div className="w-full mb-12">
            ...
            >
              <SelectTrigger className="w-full !border-t-0 !border-x-0 !px-0">
              ...
              <SelectContent className="w-full bg-background-accent-lighter">
                ...
                <SelectItem
                  value="3+ Bedrooms"
                  className="!py-3 text-sm font-semibold cursor-pointer hover:bg-background-accent"
                >
                  3+ Bedrooms
                </SelectItem>
              </SelectContent>
          ...
          <div className="mb-4">
            ...
            <Select
              ...
              onValueChange={(val) => handleSelectChange("rentPriceRange", val)}
            >
          ...
          <div className="mb-4">
            ...
            <Select
              ...
              onValueChange={(val) => handleSelectChange("rentMoveInDate", val)}
            >
              <SelectTrigger className="w-[240px]">
