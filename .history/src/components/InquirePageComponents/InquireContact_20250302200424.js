  ...
  return (
    <div className="flex flex-col items-start justify-start gap-8 sm:gap-12 max-[825px]:flex-row max-[825px]:justify-between max-[825px]:flex-wrap">
      ...
      <div className="flex flex-col gap-1 items-start justify-start">
        <h5 className="uppercase text-base xl:text-md min-[2048px]:text-lg text-foreground-accent ">
          Address
        </h5>
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="flex flex-col items-start justify-start text-foreground-dark uppercase text-base xl:text-md min-[2048px]:text-lg"
        >
      ...
      <div className="flex flex-col gap-1 items-start justify-start">
        ...
        <Link
          ...
          className=" text-foreground-dark uppercase text-base xl:text-md min-[2048px]:text-lg break-words"
        >
      ...
      <div className="flex flex-col gap-1 items-start justify-start">
        ...
        <Link
          ...
          className=" text-foreground-dark uppercase text-base xl:text-md min-[2048px]:text-lg"
        >
