  ...
  return (
    <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col w-full max-w-[400px]">
                <div className="flex flex-col border-b border-background-dark ">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="bg-transparent outline-none ring-0 active:-right-0 focus:ring-0 pb-2 text-foreground-input"
                  />
                </div>
      ...
      <div className="w-full flex flex-col items-start mb-12">
        <label className="text-md text-foreground-dark uppercase mb-3">
      ...
      {formData.interestedIn === "Renting" && (
        <>
          ...
          <div className="w-full mb-12">
            <label className="block text-md mb-1 uppercase">
              Desired Layout *
            </label>
            <Select
            ...
            >
              <SelectTrigger className="w-full !border-t-0 !border-x-0 !px-0 !text-base !pb-2 !text-foreground-input">
      ...
      {formData.interestedIn === "Buying" && (
        <>
          ...
          {/* Pre-approved Input */}
          <div className="w-full mb-12">
            <label className="block text-md uppercase">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-transparent border-b border-background-dark outline-none focus:ring-0 w-full pb-2 text-foreground-input"
            />
          </div>
        </>
      )}
      ...
      {formData.interestedIn === "Selling" && (
        <>
          ...
          <div className="flex items-center gap-2 mb-12">
            <p className="uppercase text-md text-foreground-dark">
              Proprerty address:
            </p>
          </div>
          ...
          <div className="flex justify-between gap-12 w-full mb-12">
            {/* Street */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase">Street *</label>
              <input
                type="text"
                name="sellingAddressStreet"
                value={formData.sellingAddressStreet}
                onChange={handleChange}
                className="bg-transparent border-b border-background-dark outline-none focus:ring-0 pb-2 text-foreground-input w-full"
              />
            ...
            {/* City */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase">City *</label>
              <input
                type="text"
          ...
          <div className="flex justify-between gap-12 w-full mb-12">
            {/* State */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase">State *</label>
              <input
                type="text"
            ...
            {/* Zip Code */}
            <div className="w-full max-w-[400px]">
              <label className="block text-md uppercase">Zip Code *</label>
              <input
                type="text"
          ...
          {/* Layout (Full Width) */}
          <div className="w-full mb-12 ">
            <label className="block text-md uppercase">Layout *</label>
            <Select
      ...
      <div className="w-full flex items-start justify-between gap-1">
        <button type="submit" className="--btn-dark !px-12 !pt-3 !pb-2">
          Submit
        </button>
        <p className="text-base text-foreground-dark">*Required Fields</p>
      </div>
    </form>
  );
};
