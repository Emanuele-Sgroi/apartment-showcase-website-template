      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn("!w-full justify-between !px-0 h-10", className)}
          >
        ...
        <PopoverContent
          ...
          sideOffset={0}
          className={cn(
            "p-0 w-full !max-w-none border-t-0",
            "bg-gray-100" // optional
            // if your top border is from the popover, remove it with border-t-0
          )}
        >
          <Command>
