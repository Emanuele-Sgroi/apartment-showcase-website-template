    ...
    <form onSubmit={handleSubmit}>
      <div className="w-full flex flex-wrap gap-12 mb-12">
        ...
        <div className="w-full flex justify-between gap-12">
          {/* First Name */}
          <div className="w-full max-w-[400px] min-[2048px]:max-w-[480px]">
            <div className="flex flex-col border-b border-background-dark ">
              <label className="text-md min-[2048px]:text-lg text-foreground-dark uppercase">
                First Name *
              </label>
              <input
                type="text"
                ...
                className="bg-transparent outline-none ring-0 active:-right-0 focus:ring-0 pb-2 text-foreground-input min-[2048px]:text-lg"
              />
            </div>
            {!!errors.firstName && (
      ...
      <div className="w-full flex flex-wrap gap-12 mb-12">
        ...
        <div className="w-full flex justify-between gap-12">
          ...
          <div className="flex flex-col w-full max-w-[400px] min-[2048px]:max-w-[480px]">
            <label className="text-md min-[2048px]:text-lg text-foreground-dark uppercase mb-3">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label
                  htmlFor="brokerYes"
                  className="text-md min-[2048px]:text-lg"
                >
                  Yes
                </Label>
              </div>
      ...
      <div className="w-full flex flex-col items-start mb-12">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="renting" className="text-md min-[2048px]:text-lg">
              Renting
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="Buying" id="buying" />
            <Label htmlFor="buying" className="text-md min-[2048px]:text-lg">
              Buying
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="Selling" id="selling" />
            <Label htmlFor="selling" className="text-md min-[2048px]:text-lg">
              Selling
            </Label>
          </div>
        </RadioGroup>
      ...
      {formData.interestedIn === "Renting" && (
        <>
          ...
          <div className="w-full mb-12">
            <label className="block text-md min-[2048px]:text-lg mb-1 uppercase">
              Desired Layout *
            </label>
            <Select
            ...
            >
              <SelectTrigger className="w-full !border-t-0 !border-x-0 !px-0 !text-base !pb-2 !text-foreground-input min-[2048px]:!text-lg">
      ...
      {formData.interestedIn === "Buying" && (
        <>
          {/* Desired Layout */}
          <div className="w-full mb-12">
            <label className="block text-md min-[2048px]:text-lg uppercase mb-1">
              Desired Layout *
            </label>
            <Select
          ...
          {/* Pre-approved Input */}
          <div className="w-full mb-12">
            <label className="block text-md min-[2048px]:text-lg uppercase">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-transparent border-b border-background-dark outline-none focus:ring-0 w-full pb-2 text-foreground-input min-[2048px]:text-lg"
            />
          </div>
        </>
      )}
      ...
      {formData.interestedIn === "Selling" && (
        <>
          ...
          <div className="flex items-center gap-2 mb-12">
            <p className="uppercase text-md min-[2048px]:text-lg text-foreground-dark">
              Proprerty address:
            </p>
          </div>
          ...
          <div className="flex justify-between gap-12 w-full mb-12">
            ...
            <div className="w-full max-w-[400px]">
              ...
              <input
                ...
                onChange={handleChange}
                className="bg-transparent border-b border-background-dark outline-none focus:ring-0 pb-2 text-foreground-input w-full min-[2048px]:text-lg"
              />
            ...
            >
              <SelectTrigger className="w-full !border-t-0 !border-x-0 !px-0 !text-base !pb-2 !text-foreground-input min-[2048px]:!text-lg">
                <SelectValue
                  ...
                  className="!pb-2 !text-foreground-input"
                />
              </SelectTrigger>
              <SelectContent className="w-full bg-background-accent-lighter max-h-[300px] overflow-y-auto luxury-scrollbar">
                <SelectItem
      ...
      <div className="w-full flex items-start justify-between gap-1">
        <button
          type="submit"
          className="--btn-dark !px-12 !pt-3 !pb-2 min-[2048px]:!text-lg"
        >
          Submit
        </button>
        <p className="text-base min-[2048px]:text-md text-foreground-dark">
          *Required Fields
        </p>
      </div>
    </form>
