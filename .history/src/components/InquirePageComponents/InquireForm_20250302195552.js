...
const InquireForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="w-full flex flex-wrap gap-10 sm:gap-12 mb-12">
        {/* First & Last Name */}
        <div className="w-full flex justify-between gap-10 sm:gap-12 max-[565px]:flex-col">
          {/* First Name */}
      ...
      {(formData.isAgentOrBroker === "Yes" ||
        ...
        <div className="w-full flex flex-wrap gap-10 sm:gap-12 mb-12">
          {/* If Q1 OR Q2 ARE YES */}
          <div className="w-full flex justify-between gap-10 sm:gap-12 flex-col md:flex-row">
      ...
      {formData.interestedIn === "Renting" && (
        <>
          ...
          <div className="flex justify-between gap-10 sm:gap-12 w-full mb-12 max-[565px]:flex-col">
            {/* Move-in Date */}
            <div className="w-full max-[565px]:max-w-full max-w-[400px] min-[2048px]:max-w-[480px]">
              <label className="block text-base xl:text-md min-[2048px]:text-lg mb-1 uppercase">
                Move-in Date *
      ...
      {formData.interestedIn === "Buying" && (
        <>
          ...
          <div className="w-full flex justify-between gap-10 sm:gap-12 mb-12 max-[565px]:flex-col">
            {/* Price Range */}
            <div className="w-full max-[565px]:max-w-full max-w-[400px] min-[2048px]:max-w-[480px]">
              <label className="block text-base xl:text-md min-[2048px]:text-lg uppercase mb-1">
                Price Range *
