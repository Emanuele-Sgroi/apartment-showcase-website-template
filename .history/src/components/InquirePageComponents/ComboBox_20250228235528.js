    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "justify-between h-10 w-full !border-t-0 !border-x-0 !pl-0", // standard height
            className
          )}
        >
      ...
      <PopoverContent className="p-0 !w-full !max-w-full">
        <Command>
          <CommandList className="w-full max-h-52 overflow-auto luxury-scrollbar">
