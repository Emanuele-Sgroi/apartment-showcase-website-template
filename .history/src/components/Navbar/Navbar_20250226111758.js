  ...
  return (
    <>
      ...
      <nav
        ...
        ${
          isAtTop
            ? "bg-transparent max-md:pl-4 pt-8 md:pt-16"
      ...
      >
        <div className="w-full flex items-center justify-start md:justify-center lg:justify-between py-4 md:px-6 lg:px-8 xl:px-12 box-border">
          {/* 🍔 Mobile Menu Icon */}
          <button
            onClick={() => setIsMenuOpen(true)}
            className={`md:hidden w-12 h-12 flex items-center justify-center text-foreground-light z-[1001]  ${
              isAtTop
