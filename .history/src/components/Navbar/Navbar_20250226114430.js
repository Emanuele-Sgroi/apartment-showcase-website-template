        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="mobile-menu fixed top-0 left-0 w-full max-w-[280px] h-full bg-background-dark shadow-lg z-[999] flex flex-col items-start px-6 pt-24"
            >
              {/* Close Button */}
              <button
