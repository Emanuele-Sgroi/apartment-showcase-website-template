...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full flex items-center justify-start md:justify-center lg:justify-between max-md:pl-6 max-md:pt-6 md:py-4 md:px-6 lg:px-8 xl:px-12 box-border">
          {/* 🍔 Mobile Menu Icon */}
          <button
