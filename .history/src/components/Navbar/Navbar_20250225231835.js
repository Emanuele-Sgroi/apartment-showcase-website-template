...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-center lg:justify-between py-4 px-6 lg:px-8 xl:px-12 box-border">
        {/* Left links */}
        <ul className="max-sm:hidden flex items-center gap-6 xl:gap-8">
          <li>
