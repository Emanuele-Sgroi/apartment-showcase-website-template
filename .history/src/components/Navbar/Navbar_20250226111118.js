...
const Navbar = () => {
  ...
  return (
    <>
      {/* 🖥️ Desktop Navbar */}
      <nav
        className={`fixed top-0 left-0 w-fit md:w-full h-[64px] flex items-center justify-center max-md:rounded-full z-[999] 
      ...
      >
        <div className="w-full flex items-center justify-start md:justify-center lg:justify-between py-4 px-6 lg:px-8 xl:px-12 box-border">
          ...
          <button
            ...
            className="md:hidden flex items-center text-foreground-light z-[1001]"
          >
            <Menu size={28} />
          </button>
