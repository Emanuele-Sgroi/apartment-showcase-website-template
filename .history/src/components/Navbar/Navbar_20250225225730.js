...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      ${isAtTop ? " bg-transparent" : " bg-background-dark shadow-md"}
      transition-all duration-700 ease-in-out`}
    >
      <div
        className={`w-full flex items-center justify-between py-4 px-6 lg:px-12 box-border  ${
          isAtTop ? "translate-y-8 " : "translate-y-0"
        }`}
      >
        {/* Left links */}
