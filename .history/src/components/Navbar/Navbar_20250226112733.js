        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              animate={{ opacity: 0.5 }}
              exit={{ opacity: 0 }}
              className="w-full h-screen fixed inset-0 bg-background-dark backdrop-blur-md z-[999]"
            />
            ...
            <motion.div
              ...
              className=" fixed top-0 left-0 w-[280px] h-full bg-background-dark shadow-lg z-[999] flex flex-col items-start px-6 pt-12"
            >
              {/* ❌ Close Button */}
              <button
