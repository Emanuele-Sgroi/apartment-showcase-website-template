      ...
      <div className="flex flex-col justify-center items-center gap-12 ">
        ...
        >
          ...
          <input
            ...
            required
            className="w-auto px-4 py-3 text-base border border-background-light focus:outline-none focus:ring-2 focus:border-background-accent order-background-light bg-transparent"
          />
