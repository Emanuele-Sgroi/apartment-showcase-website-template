...
const TextAndImageSection = ({
  ...
  return (
    ...
    >
      <div
        className={`w-full flex items-center gap-12 xl:gap-20 ${
      ...
      >
        ...
        >
          <div className="w-full xl:w-min lg:min-w-[450px] xl:min-w-[500px] 2xl:min-w-[600px] flex justify-center items-start flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
