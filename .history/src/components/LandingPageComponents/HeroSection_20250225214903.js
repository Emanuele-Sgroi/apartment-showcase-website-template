    ...
    <section className="relative w-full min-h-screen h-full flex justify-center items-center p-6">
      ...
      >
        <motion.h5
          ...
          className="text-foreground-light font-light md:font-medium text-xxs sm:text-xs md:text-sm text-center"
        >
          PRIME WILLIAMSBURG
        </motion.h5>
        ...
        <motion.p
          ...
          className="text-foreground-light font-semibold text-center text-xs md:text-base"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-28 md:bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer !z-20 transition-all duration-300 hover:opacity-80"
      >
