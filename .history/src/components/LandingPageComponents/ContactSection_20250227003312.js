      ...
      <div className="flex flex-col justify-center items-center gap-12 ">
        ...
        >
          ...
          <input
            ...
            required
            className="w-auto px-4 py-3 text-base text-foreground-light border border-background-light focus:outline-none focus:ring-1 focus:ring-background-accent focus:border-background-accent bg-transparent"
          />
