  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-fit flex justify-center items-end flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
            ...
            {/* Title */}
            <div className="flex flex-col items-center justify-end mt-6 mb-12">
              {words.map((word, i) => (
                <h2
                  key={i}
            ...
            {/* Description */}
            <p className="max-w-[595px] text-foreground-dark text-sm sm:text-md min-[2048px]:text-[24px] mb-12">
              {description}
            </p>
