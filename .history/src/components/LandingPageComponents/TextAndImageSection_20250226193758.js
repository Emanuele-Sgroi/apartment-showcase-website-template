    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-1/2 h-full flex items-start justify-center bg-yellow-500 "
        >
          <div className="w-full h-full max-w-[595px] flex justify-center items-start flex-col text-left bg-red-500">
            {/* Small Title */}
            {smallTitle && (
