    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-1/2 h-full flex flex-col items-start justify-center gap-12 text-left"
        >
          {/* Small Title */}
          {smallTitle && (
          ...
          {/* Description */}
          <p className="text-foreground-dark text-sm sm:text-base min-[2048px]:text-[24px]">
            {description}
          </p>
