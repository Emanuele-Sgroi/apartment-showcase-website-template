  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-min min-w-[600px] flex justify-center items-start flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
            ...
            {/* Description */}
            <p className="min-[2048px]:w-[1000px] text-foreground-dark text-sm sm:text-md min-[2048px]:text-[24px] mb-12">
              {description}
            </p>
