    ...
    <section className="relative w-full min-h-screen h-full flex justify-center items-center p-6">
      ...
      >
        <motion.h5
          ...
          className="text-foreground-light font-medium text-xxs sm:text-xs md:text-sm text-center"
        >
          PRIME WILLIAMSBURG
        </motion.h5>
        ...
        <motion.p
          ...
          className="text-foreground-light font-semibold text-center text-xxs sm:text-xs md:text-base"
        >
