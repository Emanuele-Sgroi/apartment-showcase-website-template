...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen h-full flex justify-center items-center">
      ...
      >
        <motion.h5
          ...
          className="text-foreground-light font-medium text-sm"
        >
          PRIME WILLIAMSBURG
        </motion.h5>
        ...
        <motion.h1
          ...
          className="display-font text-foreground-light "
        >
          ONE NORTHSIDE PIERS
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-foreground-light font-semibold"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2  cursor-pointer !z-20 transition-all duration-300 hover:opacity-80"
      >
