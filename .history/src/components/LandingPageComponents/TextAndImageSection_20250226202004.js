...
const TextAndImageSection = ({
  ...
  return (
    ...
    >
      <div
        className={`w-full flex items-center max-[850px]:gap-12  gap-10 xl:gap-20 max-[850px]:flex-col ${
      ...
      >
        ...
        <motion.div
          ...
          className={`max-[850px]:w-full w-1/2 h-full flex max-[850px]:items-center items-start max-[850px]:justify-center  ${
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: "easeOut" }}
          className={`max-[850px]:w-full w-1/2 overflow-hidden flex max-[850px]:justify-center  ${
            isTextOnTheLeft ? "justify-start" : "justify-end"
          }`}
        >
          <div
            className="relative w-full xl:max-w-[595px] min-[2048px]:max-w-full h-[600px] sm:h-[705px] min-[2048px]:h-[1000px] overflow-hidden"
