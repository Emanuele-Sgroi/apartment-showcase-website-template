  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-full h-full max-w-[595px] min-[2048px]:max-w-full flex justify-center items-start flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
            ...
            <div className="flex flex-col items-center justify-start mt-6 mb-12">
              {words.map((word, i) => (
                <h2
                  key={i}
                  className="display-font text-foreground-dark text-[44px] md:text-[55px] lg:text-[78px] 2xl:text-[100px] min-[2048px]:text-[150px] font-bold leading-[1] "
                >
                  {word.trim()}
                </h2>
              ))}
            ...
            {/* Description */}
            <p className="text-foreground-dark text-sm sm:text-md min-[2048px]:text-[24px] mb-12">
              {description}
            </p>
        ...
        >
          <div
            className="relative w-full max-w-[595px] min-[2048px]:max-w-full h-[705px] min-[2048px]:h-[1000px] overflow-hidden"
