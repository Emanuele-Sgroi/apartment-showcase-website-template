    ...
    <section className="relative w-full min-h-screen h-full flex justify-center items-center p-6">
      ...
      >
        <motion.h1
          ...
          className="display-font text-foreground-light text-center text-[37px] sm:text-2xl md:text-[55px] lg:text-3xl min-[2048px]:text-[120px]"
        >
          ONE NORTHSIDE PIERS
        </motion.h1>
        ...
        >
          <Link href="/inquire" className="--btn-primary mt-6">
            INQUIRE
          </Link>
        </motion.div>
      </motion.div>
