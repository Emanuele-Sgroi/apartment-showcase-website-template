        ...
        <div className="flex flex-col items-center justify-center">
          {words.map((word, i) => (
            <motion.h2
              ...
              className="display-font text-foreground-light md:text-[55px] lg:text-[65px] xl:text-[78px] 2xl:text-[100px] min-[1537px]:text-[150px] font-bold leading-[1] text-center "
            >
              {word.trim()}
            </motion.h2>
          ))}
