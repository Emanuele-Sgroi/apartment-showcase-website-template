    ...
    >
      ...
      >
        ...
        <motion.div
          initial={{
            opacity: 0,
            x: window.innerWidth > 850 ? (isTextOnTheLeft ? 50 : -50) : 0,
            y: window.innerWidth <= 850 ? 30 : 0,
          }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: "easeOut" }}
          className={`max-[850px]:w-full w-1/2 overflow-hidden flex max-[850px]:justify-center pb-6 md:pb-0 px-2 md:px-0 ${
