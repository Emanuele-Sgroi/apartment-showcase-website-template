    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-1/2 h-full flex items-start justify-end "
        >
          <div className="w-full h-full max-w-[595px] flex justify-center items-start flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.7, ease: "easeOut" }}
          className="w-1/2 overflow-hidden flex justify-start"
        >
          <div
            className="relative w-full max-w-[595px] h-[705px] overflow-hidden"
