    ...
    >
      <div className="flex flex-col justify-center items-center gap-12 ">
        ...
        >
          ...
          <button
            type="submit"
            className="w-[180px] md:w-[200px] h-[48px] px-6 bg-background-accent text-foreground-light font-semibold border border-background-light transition-all hover:bg-opacity-80"
          >
            Submit
          </button>
        </form>
