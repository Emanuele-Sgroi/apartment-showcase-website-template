  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-full xl:w-min xl:min-w-[500px] 2xl:min-w-[600px] flex justify-center items-start max-[850px]:justify-center max-[850px]:items-center  flex-col text-left">
            {/* Small Title */}
            {smallTitle && (
