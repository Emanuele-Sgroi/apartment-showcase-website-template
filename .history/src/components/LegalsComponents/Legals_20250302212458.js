...
const Legals = ({ heroTitle, content = {} }) => {
  ...
  return (
    <>
      {/* Hero / Top Section */}
      <section className="w-full bg-background-dark py-[56px] md:py-[80px] 2xl:py-[120px] min-[2048px]:py-[280px] px-8 md:px-[64px] 2xl:px-[120px] min-[2048px]:px-[200px] min-h-[70vh]">
