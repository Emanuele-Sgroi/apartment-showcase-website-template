  ...
  const richTextOptions = {
    ...
    renderNode: {
      ...
      [BLOCKS.HEADING_2]: (node, children) => (
        <h2 className="my-4 text-[28px] md:text-2xl font-bold leading-tight">
          {children}
        </h2>
      ),
      ...
      [BLOCKS.HEADING_5]: (node, children) => (
        <h5 className="my-1 text-md md:text-base font-semibold leading-tight">
          {children}
        </h5>
      ),
      [BLOCKS.HEADING_6]: (node, children) => (
        <h6 className="my-1 text-md md:text-base font-semibold leading-tight">
          {children}
        </h6>
      ),
      // Render UL
