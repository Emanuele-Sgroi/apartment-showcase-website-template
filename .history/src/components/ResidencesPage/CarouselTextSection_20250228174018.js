  ...
  return (
    <section className="w-full bg-background-light pb-[56px] md:pb-[80px] 2xl:pb-[120px] min-[2048px]:pb-[200px]">
      ...
      >
        {/* Text */}
        <motion.div
          className={`w-full md:w-[30%] flex ${
            isTextOnTheLeft ? "justify-start" : "justify-start"
          }`}
        ...
        >
          ...
          >
            {slidesRef.map((slide, index) => (
              <SwiperSlide
                key={index}
                className="w-full max-w-[1020px] min-[2048px]:max-w-[1200px] flex items-center justify-center flex-col"
              >
                <div
