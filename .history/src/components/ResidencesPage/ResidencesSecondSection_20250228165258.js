...
const ResidencesSecondSection = ({ residencesContent }) => {
  ...
  return (
    <section className="w-full bg-background-light py-[56px] md:py-[80px] 2xl:py-[120px] min-[2048px]:py-[200px] px-8 md:px-10 xl:px-[64px] 2xl:px-[120px] min-[2048px]:px-[200px]">
      <div className="w-full flex flex-col-reverse md:flex-row items-start justify-center gap-12 md:gap-8 lg:gap-16 xl:gap-32">
        {/* Text */}
        <motion.div
        ...
        >
          <p className="w-full md:max-w-[375px]  text-foreground-dark text-base sm:text-md min-[2048px]:text-[24px] text-left md:text-right font-medium">
        ...
        {/* Image */}
        <motion.div
          className="w-full md:w-[70%] flex items-start justify-start"
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
