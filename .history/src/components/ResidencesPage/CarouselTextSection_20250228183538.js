  ...
  return (
    <section className="w-full bg-background-light pb-[56px] md:pb-[80px] 2xl:pb-[120px] min-[2048px]:pb-[200px]">
      ...
      >
        {/* Text */}
        <motion.div
          className={`w-full md:w-[45%] xl:w-[30%] flex items-end px-8 md:px-0 ${
            isTextOnTheLeft
              ? "justify-end md:pl-10 xl:pl-[64px] 2xl:pl-[120px] min-[2048px]:pl-[200px]"
              : "justify-start md:pb-20 md:pr-10 xl:pr-[64px] 2xl:pr-[120px] min-[2048px]:pr-[200px]"
          }`}
        ...
        {/* Carousel */}
        <motion.div
          className={`w-full md:w-[55%] xl:w-[70%] max-w-[1020px] min-[2048px]:max-w-[1200px]  flex items-start ${
